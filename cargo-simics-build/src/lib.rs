...
impl App {
    pub fn run(cmd: Cmd) -> Result<PathBuf> {
        ...
        // Remove SIMICS_BINDINGS_NOCLEAN from cargo simics-build outputs to reduce the size
        // of the sys bindings as much as possible
        build_cmd.env_remove("SIMICS_BINDINGS_NOCLEAN");
