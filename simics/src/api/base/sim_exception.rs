...
//!
//! These should typically not be used directly, most SIMICS api functions provided by
//! this crate use the `#[simics_exception]` attribute to automatically convert thrown
//! exceptions into a [`Result`]. This allows more idiomatic error handling
//! via `Result`s.
